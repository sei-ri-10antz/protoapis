...
func (m *GetUserRequest) validate(all bool) error {
	...
	if _, ok := _GetUserRequest_ResourcsName_InLookup[m.GetResourcsName()]; !ok {
		err := GetUserRequestValidationError{
			field:  "ResourcsName",
			reason: "value must be in list [blog news]",
		}
		if !all {
			return err
		}
...
var _GetUserRequest_ResourcsName_InLookup = map[string]struct{}{
	"blog": {},
	"news": {},
}
...
func (m *ListUsersRequest) validate(all bool) error {
	...
	if _, ok := _ListUsersRequest_ResourcsName_InLookup[m.GetResourcsName()]; !ok {
...
var _ListUsersRequest_ResourcsName_InLookup = map[string]struct{}{
	"blog": {},
	"news": {},
}
